...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil-nerd-commenter atom-one-dark-theme emmet-mode php-mode dot-mode solarized-theme yaml-mode which-key web-mode use-package try smartparens rainbow-delimiters org-bullets nginx-mode magit linum-relative helm-projectile helm-ag flycheck evil-leader editorconfig color-theme-sanityinc-solarized avy auto-complete ag))))
(custom-set-faces
